...
events_results  <- mclapply(x, calcu_rates)
...
write.csv(results_different_sample_size, "condition1_results.csv")
write.csv(results_combined, "condition1_results_full.csv")